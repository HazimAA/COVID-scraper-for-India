...
xx = dates.map(pd.Timestamp.date)
...
fig_tested = px.line(df3, x=xx, y=data_tested)
...
#     # print(df3)
    ...
    fig_tested = px.line(df5, x=xx, y=data_tested)
    fig_tested.update_layout(
        plot_bgcolor=colors['background'],
        paper_bgcolor=colors['white'],
        font_color=colors['text'],
